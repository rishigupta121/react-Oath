...
class BillProductBase extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    getCounter() {
        ...
        return <div className="row counter">
            <span className="checkout-counter">{this.state.count}x</span>
        </div>
    }
    ...
    render() {
        return (
            <div className="checkout-item">
                ...
                <div className="checkout-items-middle-left">
...
BillProductBase.contextType = ThemeContext;

const BillProduct = compose(
    withRouter,
)(BillProductBase);
